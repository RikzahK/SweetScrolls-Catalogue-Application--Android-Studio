...
public class burgerrecipe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the content view to the layout defined in activity_burgerrecipe.xml
        setContentView(R.layout.activity_burgerrecipe);
    }
